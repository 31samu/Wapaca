...
const metadata={fetchedAt:subscriptions.map(source=>source.fetchedAt).filter(Boolean).sort()[0]};
...
const shared={...config,...config.module,course:defaultCourse,today,snapshotDate,rooms:true,iconSpace:true};
